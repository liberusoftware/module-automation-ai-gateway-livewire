...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            AiGatewayResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    {
        return view('module-automation-ai-gateway-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return AiGatewayResource::query()->when(
            $teamId === null,
